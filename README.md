...
This project was developed to demonstrate the simple idea of ​​a retro 3d calculator "RICOMAC RC-8F" using the React Three Fiber library.
...
- ### Buttons:
Buttons placed proceduraly from an array, and then marked as ```DOM Components``` by using ```"Html"``` from ```React Three Drei``` library.
<br />
